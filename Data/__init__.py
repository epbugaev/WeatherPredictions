...
Each version (``v1``, ``v3``) has slightly different ``__init__`` signatures;
the registered factory accepts the common ``params`` dict from ``train.py`` and
forwards only the keys the underlying class expects.
"""
