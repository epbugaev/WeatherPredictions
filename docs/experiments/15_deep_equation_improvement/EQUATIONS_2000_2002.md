...
| 5 | 4169284 | r1b: то же, USA-2000, CLIM_OUT | — | — |
...
занижены ×4: PGF-x, дивергенция (→ω), зональная адвекция. Эффект на невязки —
в раунде 1b (вариант C_best против C_best14).
...
**Г9. u на USA.** После d_y-фикса u стала худшей динамической переменной на
кропе (2.668): drop-one показывает, что удаление Кориолиса УЛУЧШАЕТ u до 1.402
при величине члена 3.26× тенденции — то есть f·v не компенсируется занижённым
×4 барическим градиентом −∂Φ/∂x (Г6). Проверка dx-фикса — раунд 1b.
