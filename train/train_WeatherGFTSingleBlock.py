"""WeatherGFT (single-block variant) training entry point, pure-PyTorch."""
...
def train_model() -> None:
    """Construct the 12-body-layer GFT variant and run training."""
    torch_model = GFT(
        hidden_dim=256,
        ...
        body_layers=[2] * 12,
        body_heads=[6] * 12,
        body_scaling_factors=[1] * 12,
        body_dim_factors=[1] * 12,
    ...
    run_legacy_training(
        ...
        strategy_name="mutiout",
        train_loader_kwargs={"batch_size": 2, "num_workers": 4, "shuffle": True},
        val_loader_kwargs={"batch_size": 2, "num_workers": 4},
        lr=1e-4,
        max_epoch=20,
        log_code_file="/home/ebugaev/WeatherPredictions/Models/WeatherGFTSingle.py",
    )
