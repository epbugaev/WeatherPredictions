"""Experimental: PredFormerGFTSingle on the full WeatherBench v1 grid."""
...
def train_model() -> None:
    """Build PredFormerGFTSingle with the original Small-World shape."""
    torch_model = PredFormerGFTSingle(
        hidden_dim=256,
    ...
    run_legacy_training(
        ...
        train_loader_kwargs={"batch_size": 1, "num_workers": 4, "shuffle": True},
