...
def train_model(devices, num_nodes):
    ...
    valid_data = WeatherBench128(start_time=val_start_time, end_time=val_end_time,
                                ...
                                end_time_y=23, 
                                cut=[[128 - 92, 128 - 60], [256 - 131, 256 - 67]])  
    valid_loader = DataLoader(valid_data, batch_size=8, shuffle=True, num_workers=4)
    ...
    logger.experiment.log_code(file_name='/home/epbugaev/WeatherPredictions/Models/PredFormerTwoO.py')
