...
def train_model(devices, num_nodes):
    ...
    val_end_time = '2004-01-25 00:00:00' # '2004-01-01 23:00:00' #
    ...
    indices = list(range(0, len(train_data), 23))[:-5]
    ...
    metrics = Metrics(valid_data.data_mean_tensor, valid_data.data_std_tensor)
