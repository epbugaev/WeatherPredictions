...
def train_model(devices, num_nodes):    
    ...
    train_data = WeatherBench128(start_time=train_start_time, end_time=train_end_time,
                                include_target=False, lead_time=1, interval=1, muti_target_steps=6, cut=[[128 - 92, 128 - 60], [256 - 131, 256 - 67]])
    train_loader = DataLoader(train_data, batch_size=16, shuffle=True, num_workers=4)


    valid_data = WeatherBench128(start_time=val_start_time, end_time=val_end_time,
                                include_target=False, lead_time=1, interval=1, muti_target_steps=12, cut=[[128 - 92, 128 - 60], [256 - 131, 256 - 67]])
    ...
    EXP_NAME = "WeatherGFT coef learnable"
    ...
    logger.experiment.log_code(file_name='/home/ebugaev/WeatherPredictions/Models/WeatherGFTSmallWorld.py')
