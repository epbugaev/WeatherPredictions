#!/bin/bash
#SBATCH --job-name=phys-fixC-scaleDiff
...
# =============================================================================
# Fix C: воспроизвести production semantics — scale_diff + .detach() после
# каждого Euler-шага. Оригинальные формулы сохранены. NaN не будет.
# CPU-only.
# =============================================================================
set -euo pipefail
...
echo "[phys-fixC] JobID=${SLURM_JOB_ID:-local} host=$(hostname) git_sha=$(git rev-parse --short HEAD 2>/dev/null)"
