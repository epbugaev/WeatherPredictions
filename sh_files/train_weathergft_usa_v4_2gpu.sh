...
: "${ORIG_MEMMAP:?Set ORIG_MEMMAP to the packed USA memmap .dat for v4. Use weathergft_usa for the legacy WeatherBench files.}"
...
exec bash "${weatherpred__launcher}" weathergft_usa_v4 "$@"
